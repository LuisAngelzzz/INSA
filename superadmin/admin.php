    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.php">INSA</a>
...
John Abraham</span>is now following you
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/images.jpg" alt="" class="user-avatar-md rounded-circle"></a>
                            ...
                            <li class="nav-item " style="visibility:hidden">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#">Tabla de ventas</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar un Nuevo Gerente</h5>
        ...
        <div class="modal-body">
          ...
          <form id="formularioNuevoUsuario" action="insert_gerente.php" method="POST">
    ...
    function agregarUsuario() {
      ...
      if (nuevoID && nuevoNombreUsuario && nuevaContraseña && nuevoActivo) {
        ...
        alert('Por favor, completa todos los campos.');
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Gerentes</h5>
                            <div class="card-body">
...
$sql = "SELECT id, nombreUsuario, email ,activo, contraseña FROM infousuario where privilegio = 2";
...
$(document).ready(function() {
    $(".btn-activo").click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "actualizar_estado_gerente.php",
