    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar un Nuevo Administrador</h5>
        ...
        <div class="modal-body">
          ...
          <form id="formularioNuevoUsuario" action="insert_usuario.php" method="POST">
...
$(document).ready(function() {
    $(".btn-activo").click(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "actualizar_estado_admin.php",
